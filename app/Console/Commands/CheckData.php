...
class CheckData extends Command
{
    ...
    private function checkPaidToDate()
    {
        ...
        $clients = DB::table('clients')
            ...
            ->get([
                'clients.id',
                'clients.paid_to_date',
                DB::raw('sum(coalesce(payments.amount - payments.refunded, 0)) as amount')
            ]);
    ...
    private function checkInvoiceBalances()
    {
        $invoices = DB::table('invoices')
            ...
            ->get([
                ...
                'invoices.amount',
                'invoices.balance',
                DB::raw('coalesce(sum(payments.amount - payments.refunded), 0)')
            ]);
    ...
    private function checkClientBalances()
    {
        ...
        $clients = $clients->groupBy('clients.id', 'clients.balance')
            ...
            ->get([
                ...
                'clients.balance',
                'clients.paid_to_date',
                DB::raw('sum(invoices.balance) actual_balance')
            ]);
    ...
    private function checkInvoices()
    {
        ...
        foreach ($invoices as $invoice) {
            ...
            $result = CurlUtils::phantom('GET',
                $link . '?phantomjs=true&phantomjs_balances=true&phantomjs_secret=' . env('PHANTOMJS_SECRET'));
