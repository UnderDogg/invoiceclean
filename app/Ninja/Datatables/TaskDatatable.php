        ...
        return [
            ...
            [
                ...
                function ($model) {
                    ...
                    return $model->project_public_id ? link_to("projects/{$model->project_public_id}",
                        $model->project)->toHtml() : '';
                },
            ],
            [
                'date',
            ...
            [
                ...
                function ($model) {
                    ...
                    return link_to("tasks/{$model->public_id}/edit",
                        Utils::formatTime(Task::calcDuration($model)))->toHtml();
                },
            ],
            [
                'description',
    ...
    public function actions()
    {
        return [
            ...
            [
                ...
                function ($model) {
                    return !$model->is_running && !$model->invoice_number && (!$model->deleted_at || $model->deleted_at == '0000-00-00') && Auth::user()->can('create',
                            ENTITY_INVOICE);
                },
            ],
        ];
