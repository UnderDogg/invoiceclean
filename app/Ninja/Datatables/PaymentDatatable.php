        ...
        return [
            [
                ...
                function ($model) {
                    ...
                    return link_to("invoices/{$model->invoice_public_id}/edit", $model->invoice_number,
            ...
            [
                ...
                function ($model) {
                    ...
                    if ($model->exchange_currency_id && $model->exchange_rate != 1) {
                        $amount .= ' | ' . Utils::formatMoney($model->amount * $model->exchange_rate,
                                $model->exchange_currency_id, $model->country_id);
                    }
            ...
            [
                ...
                function ($model) {
                    if ($model->is_deleted) {
                        ...
                        return link_to("payments/{$model->public_id}/edit",
                            Utils::dateToString($model->payment_date))->toHtml();
                    }
                },
            ],
            [
        ...
        return [
            ...
            [
                ...
                function ($model) {
                    ...
                    $local = in_array($model->gateway_id,
                        [GATEWAY_BRAINTREE, GATEWAY_STRIPE, GATEWAY_WEPAY]) || !$model->gateway_id ? 0 : 1;
